...
import TextBoxWButtons from "../common/TextBoxWButtons";
import ControlMusic from "../layouts/ControlMusic/ControlMusic";
//import ControlMusic from "../layouts/ControlMusic2";
...
export default function tempHome({
	constrolmusic_cantelements,
	textboxwbuttons_text,
	textboxwbuttons_links,
	play,
	setPlay,
}) {
	return (
		<Wrapper id="Home">
			<div className="container">
				<div className="block blockA">
					<ControlMusic cant_elements={constrolmusic_cantelements} play={play} setPlay={setPlay} />
				</div>
				<TextBoxWButtons
