...
function MenuFormExp() {
	return (
		<div id="menuformexp" className="menu menu-reg">
			<div className="container">
				<div className="title">
					<h1>FORMACIÓN Y EXPERIENCIA</h1>
				</div>
				<div className="bloque">
					<div className="bloque-list border-bottom">
						<div className="list-icon margin-content">
						...
						<div className="list-tags">
							<span className="tag">Idioma Ingles</span>
						</div>
					</div>
					<div className="bloque-list border-bottom">
						<div className="list-icon margin-content">
						...
						<div className="list-tags">
							<span className="tag">Visual Basic</span>
							<span className="tag">VB6</span>
							<span className="tag">Visual Studio</span>
							<span className="tag">C#</span>
							<span className="tag">.NET</span>
							<span className="tag">.NET CORE</span>
							<span className="tag">Base de Datos</span>
							<span className="tag">SQL</span>
							<span className="tag">TSQL</span>
					...
					<div className="bloque-list ">
						...
						<div className="list-tags">
							<span className="tag">Photoshop</span>
							<span className="tag">CorelDraw</span>
						</div>
					</div>
				</div>
			</div>
